...
public interface IPhotoView {
    ...
    /**
     * Return true if the PhotoView is set to allow reset zooming status of Photos.
     */
    boolean canReset();
    ...
    /**
     * Allows you to enable/disable the zoom status reset functionality on the ImageView.
     */
